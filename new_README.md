...
The two algorithms we looked at are a naive halfplane intersection algorithm which at best scales with $ O(n^2) $

###
This sentence uses `$` delimiters to show math inline:  $O(n^2)$
## Getting started
